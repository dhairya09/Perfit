...
public class VideoPlayerActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String v_author = video.getAuthor();
        String v_title = video.getTitle();
        String v_description = video.getDescription();
        Log.e("layout", String.valueOf(layout));
        Log.e("author",v_author);
        Log.e("title",v_title);
        Log.e("desc",v_description);



        //VideoPlayerFragment fragment1 = new VideoPlayerFragment();
